...
export class SocketService {
  ...
  /**
   * Returns promise and then kills socket listener.
   * @param eventName - name of the event
   * @private
   */
  protected fromEventOnceAsPromise<T>(eventName: string): Promise<T> {
    return this.fromEventOnce<T>(eventName).toPromise();
  }
}
